...
public class JetpackAutomation {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        //Mobile APP Info
        options.setAppPackage("com.xindhu.jetpackcompose");
        options.setAppActivity("com.xindhu.jetpackcompose.MainActivity");
        ...
        try {
            ...
            driver.findElement(By.xpath("//androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View")).click();
